...
class org.red5.fitc.presentation.SpeakerBroadcaster extends MovieClip {
// Constants:
	public static var CLASS_REF = org.red5.fitc.presentation.SpeakerBroadcaster;
	public static var LINKAGE_ID:String = "org.red5.fitc.presentation.SpeakerBroadcaster";
// Public Properties:
// Private Properties:
...
// Private Methods:
	...
	private function connectionChange(evtObj:Object):Void
	{
		if(evtObj.connected) 
		{
			...
			stream.publish("api_presentation", "live");
			// show it on screen
