...
{	
	...
	import org.red5.samples.publisher.events.EnableVideoEvent;
	 ...
	 */	
	public class EnableVideoCommand implements ICommand 
	{
		/**
		* 
		*/			
	    ...
	    { 
	    	var event : EnableVideoEvent = EnableVideoEvent( cgEvent );
			// Use Delegate to playback the NetStream.
	      	netStreamDelegate.enableVideo( event.enable );
		}
