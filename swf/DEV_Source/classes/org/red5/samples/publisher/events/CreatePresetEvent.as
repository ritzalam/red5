package org.red5.samples.publisher.events
{
	...
	public class CreatePresetEvent extends CairngormEvent 
	{
		...
		* 
		*/		
		public var targetLocation : SettingsDisplayClass;
		...
		*/		
		 ...
		 */		
		public function CreatePresetEvent( targetLocation : SettingsDisplayClass,
										   hostName : String,
										   serverType : int,
										   encodingType : int,
										   proxyType : int ) 
		{
			super( DashboardController.EVENT_CREATE_PRESET );
