...
tar zxvf red5-server-1.0.2-RC1-server.tar.gz
rm red5-server-1.0.2-RC1/lib/red5-client-*.jar
...
sudo rm -rf $RED5_DIR
sudo rm -rf $NEW_RED5
sudo cp -R target/red5-server-1.0.2-RC1 $NEW_RED5
sudo ln -s $NEW_RED5 $RED5_DIR
sudo cp extras/commons-io-2.1.jar $RED5_DIR/lib/
...
sudo cp extras/red5.sh $RED5_DIR/red5.sh
...
RED5_JAR=red5-1.0r4643.jar
NEW_RED5_JAR=target/red5-server-1.0.2-RC1/red5-server.jar
