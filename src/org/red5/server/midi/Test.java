...
public class Test {
	...
	protected static Log log =
        LogFactory.getLog(Test.class.getName());
	...
	public Test() throws Exception {
		...
		MidiPlayer player = new MidiPlayer(new File("/Users/luke/Desktop/Loops_Of_Fury.mid"));
		
		// Trying to get the events..
		MidiSystem.getSequencer().getTransmitter().setReceiver(new MyReceiver());
...
//				 Hook up a receiver to the transmitter
			...
			for(MidiDevice device : devices) if(device != null) device.close();
			
	}
	
	public class MyReceiver extends Object 
		implements Receiver {
		
		public void send(MidiMessage msg,long time) {
			System.err.println("dgg");
