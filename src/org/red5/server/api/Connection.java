 ...
 * 
 * Each connection has an associated client and scope.
 * Connections may be persistent, polling, or transitent. 
...
public interface Connection extends AttributeStore {
	...
	/**
	 * Close this connection, this will disconnect the client from the assicated scope
	 */
	public void close();
	...
	/** 
	 * Dispatch an event down this connection
	 * You should call isConnected first to check its possible
	 * 
	 * @param object any kind of simple object
	 */
	 ...
	 * 
	 * @param contextPath	the desired context path, can be relative or absolute
