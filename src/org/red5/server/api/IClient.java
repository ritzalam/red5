 ...
 * object is like a HTTP session. You can create IClient objects with {@link IClientRegistry#newClient(Object[])}
 * 
 * 
...
public interface IClient extends IAttributeStore, IFlowControllable {
	 ...
	 * if not passed with connect. To assign a custom ID to the client use <code>params</code> object of 
	 * {@link IApplication#appConnect(IConnection, Object[])} method, that contains 2nd all the rest values you pass to 
