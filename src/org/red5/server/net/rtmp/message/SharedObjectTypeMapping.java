...
public class SharedObjectTypeMapping {
	...
	protected static Log log = LogFactory.getLog(SharedObjectTypeMapping.class.getName());
	...
	public static byte toByte(Type type){
		...
		case CLIENT_SEND_MESSAGE: return 0x06;
		case CLIENT_STATUS: return 0x07;
		case CLIENT_CLEAR_DATA: return 0x08;
	...
	public static String toString(Type type){
		...
		case SERVER_DISCONNECT: return "server disconnect";
		...
		case CLIENT_SEND_MESSAGE: return "client_send_message";
		case CLIENT_STATUS: return "client_status";
		case CLIENT_CLEAR_DATA: return "client_clear_data";
