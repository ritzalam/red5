...
public class SOSample implements IDemoService, ApplicationContextAware {

	protected static Log log = LogFactory.getLog(SOSample.class.getName());
	...
	public void startUp() {
		log.debug("starting the SOSample service...");
	}
	 ...
	 */
	 ...
	 {
		 String msg = "hello from SOSample";
		 return msg;
	 }
